...
<div class="fieldcontain ${hasErrors(bean: SRGroupMenuInstance, field: 'menu', 'error')} required">
	...
	<g:select id="menu" name="menu.id" from="${com.cygnus.sys.mnm.STMenu.list()}" optionKey="id" required="" value="${SRGroupMenuInstance?.menu?.id}" class="many-to-one"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: SRGroupMenuInstance, field: 'menuGroup', 'error')} required">
	...
	<g:select id="menuGroup" name="menuGroup.id" from="${com.cygnus.sys.mnm.STMenuGroup.list()}" optionKey="id" required="" value="${SRGroupMenuInstance?.menuGroup?.id}" class="many-to-one"/>
</div>
