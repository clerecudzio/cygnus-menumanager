...
<html>
	...
	<body>
		...
		<div id="create-STMenu" class="content scaffold-create" role="main">
			...
			<g:formRemote name="cygnusSTMenuSaveForm" update="pageContent" url="[controller:'STMenu', action:'create']">
			<fieldset class="form">
