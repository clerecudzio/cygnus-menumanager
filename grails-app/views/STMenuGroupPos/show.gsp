...
<html>
	...
	<body>
		<a href="#show-STMenuGroupPos" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="show-STMenuGroupPos" class="content scaffold-show" role="main">
			...
			<ol class="property-list STMenuGroupPos">
				...
				<g:if test="${STMenuGroupPosInstance?.allowMoreThanOne}">
				<li class="fieldcontain">
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="edit" id="${STMenuGroupPosInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
